...
class SomeofProduct extends StatefulWidget {
  @override
  _SomeofProductState createState() => _SomeofProductState();
}

class _SomeofProductState extends State<SomeofProduct> {
  ...
  void _showAddProductDialog() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text("Add Retail Product"),
          content: Column(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("قائمة المنتجات بالتجزئة"),
        centerTitle: true,
        actions: [
          IconButton(
